...
import com.cg.CapGame.repo.GameRepo;
import com.cg.CapGame.service.GameService;
import com.cg.CapGame.service.GameServiceImpl;
...
public class GameServiceTest {
	...
	public void test_createGame_success() {
		...
		assertEquals(game, service.add(new Game("Cricket", 11)));
	}

	@Test(expected = IllegalArgumentException.class)
	public void test_createGame_throwsExceptionForIlllegalArguments() {

		service.add(new Game("Cricket", 11));
		service.add(new Game(null, 11));
		service.add(new Game("Cricket", 0));
